...
Route::group(['middleware' => 'setlang'], function() {
  ...
  Route::post('/payspecialammount', 'Front\FrontendController@payspecialammount')->name('front.payspecialammount');
  Route::post('/paymentcomplete', 'Front\FrontendController@paymentcomplete')->name('front.paymentcomplete');
...
// Product
  ...
  //elsaraf routes
Route::post('/product/elsaraf/submit', 'Payment\product\ElsarafController@store')->name('product.elsaraf.submit');
Route::post('/product/elsaraf/notify', 'Payment\product\ElsarafController@notify')->name('product.elsaraf.notify');
Route::get('/product/elsaraf/cancle', 'Payment\product\ElsarafController@paycancle')->name('product.elsaraf.cancel');
Route::get('/product/elsaraf/return', 'Payment\product\ElsarafController@payreturn')->name('product.elsaraf.return');
    // stripe routes
...
//   Route::group(['middleware' => 'checkpermission:Role Management'], function() {
    ...
    Route::post('/elsaraf/update', 'Admin\GatewayController@elsarafUpdate')->name('admin.elsaraf.update');
