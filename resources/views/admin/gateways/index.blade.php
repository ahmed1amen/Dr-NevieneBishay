...
@section('content')
  ...
  <div class="row">
      ...
      <div class="col-lg-4">
          <div class="card">
              <form action="{{route('admin.elsaraf.update')}}" method="post">
                  @csrf
                  <div class="card-header">
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="card-title">Elsaraf</div>
                          </div>
                      </div>
                  </div>
                  <div class="card-body pt-5 pb-5">
                      <div class="row">
                          <div class="col-lg-12">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="selectgroup w-100">
                                      <label class="selectgroup-item">
                                          <input type="radio" name="status" value="1" class="selectgroup-input" {{$elsaraf->status == 1 ? 'checked' : ''}}>
                                          <span class="selectgroup-button">Active</span>
                                      </label>
                                      <label class="selectgroup-item">
                                          <input type="radio" name="status" value="0" class="selectgroup-input" {{$elsaraf->status == 0 ? 'checked' : ''}}>
                              ...
                              $elsarafInfo = json_decode($elsaraf->information, true);

                              @endphp
                              <div class="form-group">
                                  <label>Merchant Secret</label>
                                  <input class="form-control" name="merchantsecret" value="{{$elsarafInfo["merchantsecret"]}}">
                                  @if ($errors->has('merchantsecret'))
                                      <p class="mb-0 text-danger">{{$errors->first('merchantsecret')}}</p>
                                  @endif
                              </div>
