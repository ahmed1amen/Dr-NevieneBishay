...
<div class="modal fade"   id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document" style="border:3px solid;">
         <div class="modal-content">
            ...
            <div class="modal-body text-center">
               ...
               <img width="50%" src="https://smileboutiqueclinics.com/sbl1.png" alt="" />
               <div class="row justify-content-center">
               <a href="https://dr-nevienebishay.com/website2/package-order/40" class="readmore-btn mr-2" target="_blank"><span>Pay Online & Get 15% <br> OFF</span></a>
            <a href="https://dr-nevienebishay.com/website2/package-order/40" class="readmore-btn mr-2" target="_blank"><span>Use Teeth Wallet & Get 25% OFF</span></a>
            <a href="https://api.whatsapp.com/send?phone=+201211220900&text=package-questions" class="readmore-btn mr-2" target="_blank"><span>Talk To Customer Service</span></a>
              </div>
  ...
  <!-- pricing begin -->
  <div class="pricing-tables" id="packages">
     <div class="container">
       <div class="row text-center">
          <div class="col-lg-6 offset-lg-3">
        ...
        <div class="pricing-carousel common-carousel owl-carousel owl-theme">
          @foreach ($packages as $key => $package)
            <div class="single-pricing-table">
               ...
               <a href="{{route('front.packageorder.index', $package->id)}}" class="pricing-btn">{{__('auth.getit')}}</a>
          ...
          @endforeach
            ...
            <div class="row mb-3 mt-3 text-center justify-content-center">
                    <div class="col-md-1 col-2 px-1 mb-1"><img src="https://elsaraf.com/ar/img/visa.jpg" class="img-fluid w-100"></div>
                    <div class="col-md-1 col-2 px-1 mb-1"><img src="https://elsaraf.com/ar/img/Mastercard.jpg" class="img-fluid w-100"></div>
                    <div class="col-md-1 col-2 px-1 mb-1"><img src="https://elsaraf.com/ar/img/paypal.jpg" class="img-fluid w-100"></div>
                    <div class="col-md-1 col-2 px-1 mb-1"><img src="https://elsaraf.com/ar/img/Meeza card.jpg" class="img-fluid w-100"></div>
                    <div class="col-md-1 col-2 px-1 mb-1"><img src="https://elsaraf.com/ar/img/Fawry.jpg" class="img-fluid w-100"></div></div>

        <div class="row">
            <div class="text-center mt-3">
                <h4>{{__('auth.choosepackage')}}</h4><br>
                <img src="https://smileboutiqueclinics.com/tw.png" id="teethwallet"><br>
                <div class="row justify-content-center pb-4">
                <h4 class="col-lg-6 col-md-12 col-sm-12">{{__('auth.teethdescription')}}</h4>
                </div>
                <form action="payspecialammount" class="" method="POST">
                    @csrf
                    <div class="row justify-content-center">

                        <div class="col-md-4">
                            <div class="form-element">
                                <input name="name" type="text" placeholder="{{__('auth.name')}}" required="">
                                @error('name')
                                <span class="text-danger"> {{ convertUtf8($message) }} </span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-element">
                                <input name="phone" type="text" placeholder="{{__('auth.phone')}}" required="">
                                @error('phone')
                                <span class="text-danger"> {{ convertUtf8($message) }} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-element">
                                <input name="amount" type="text" placeholder="{{__('auth.amount')}}"
                                       required="">
                                @error('amount')
                                <span class="text-danger"> {{ convertUtf8($message) }} </span>
                                @enderror
                        ...
                        <button  id="btn_payspecial" type="submit" class="readmore-btn mb-4"><span>{{__('auth.chargenow')}}</span></button>
