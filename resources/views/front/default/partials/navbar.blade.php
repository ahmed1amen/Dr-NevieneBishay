...
<div class="header-navbar" style="background:white;">
    <div class="row">
       <div class="col-lg-3  col-6">
          <div class="logo-wrapper mx-auto">
             <a href="{{route('front.index')}}"><img class="ml-4" src="https://smileboutiqueclinics.com/sbl1.png" alt=""></a>
          </div>
       </div>
       <div class="mt-4 col-lg-9 col-6 {{$rtl == 1 ? 'text-left' : 'text-right'}} position-static">
          <ul class="main-menu d-flex" id="mainMenu">
             ...
             @if ($bs->is_quote == 1)
             <li><a href="https://api.whatsapp.com/send?phone=+20122537773&text=%D8%AD%D8%AC%D8%B2%20%D8%AF%D9%83%D8%AA%D9%88%D8%B1%20%D9%86%D9%8A%D9%81%D9%8A%D9%86" class="boxed-btn">{{__('auth.book')}}</a></li>
             @endif
          </ul>
