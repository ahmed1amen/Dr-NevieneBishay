...
@section('content')
  ...
  <div class="breadcrumb-area" style="background-image: url('{{asset('assets/front/img/' . $bs->breadcrumb)}}');background-size:cover;height:390px;">
     <div class="container">
        <div class="breadcrumb-txt">
           <div class="row">
              <div class="col-xl-7 col-lg-8 col-sm-10">
                 <h1>{{__('Place Order for')}}&nbsp;{{convertUtf8($package->title)}}</h1>
  ...
  <!--   quote area start   -->
  <div class="quote-area pt-30 pb-115" style="padding:50px 0px !important;">
    <div class="container" id="package-container">
      <div class="row" >
        <div class="col-lg-8">
          <form class="pay-form"  action="{{route('front.packageorder.submit')}}" method="POST">
            @csrf
    ...
    function form_validation($form, $filedName) {
        ...
        $('.pay-form').ajaxForm({
            ...
            success: function(response, textStatus, xhr, form) {
                ...
                document.getElementById('package-container').replaceWith(iframe)
