...
class FrontendController extends Controller
{
    ...
    public function submitorder(Request $request)
    {
        ...
        $info = [
            'api_token' => '2d3739c4bf2548dad371ea8486549a14',
            'customer' => [
                'customerName' => $in['name'],
                'customerMobile' => $in['contact_number'],
                'customerEmail' => $in['email'],
            ],
            'interaction' => [
                'cancelUrl' => 'http://cancelUrl.com',
                'returnUrl' => 'https://dr-nevienebishay.com/website2',
        ...
        return response()->json(json_decode($this->callAPI("https://accept.elsaraf.com/api/init", "POST", $info), true));
    ...
    public function payspecialammount(Request $request)
    {
        ...
        $info = [
            'api_token' =>  json_decode(PaymentGateway::find(20)->information,true)['merchantsecret'],
            'customer' => [
                'customerName' => $request->get('name'),
                'customerMobile' => $request->get('phone'),
                'customerEmail' => 'admin@dr-nevienebishay.com',
            ],
            'interaction' => [
                'cancelUrl' => 'http://cancelUrl.com',
                'returnUrl' => 'https://dr-nevienebishay.com/website2',
            ...
            'invoice' => [
                'items' => [
                    [
                        "itemId" => 151,
                        "name" => 'Teeth Wallet',
                        "description" => 'Teeth Wallet Credit',
                        "quantity" => "1",
